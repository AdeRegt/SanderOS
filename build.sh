...
ld -n -T src/linker.ld -o myos.bin -O2 -nostdlib build/boot.o build/kernel.o build/ata.o build/keyboard.o build/pci.o build/atapi.o build/idt.o build/interrupt.o build/screen.o build/ports.o build/iso.o build/elf.o -m elf_i386
if grub-file --is-x86-multiboot myos.bin; then
	...
	cc -c programmas/*.c -o programmas/*.o -std=gnu99 -m32 -mtune=i386
	cp programmas/*.o -a isodir/boot/modules/
